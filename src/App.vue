  ...
  <div id="app">
        ...
        <div>
          ...
          <div>
            ...
            <input v-model="coursrInfo.name" type="text" />
          </div>
          <div>
            <label for="">课程价格：</label>
            <input v-model="coursrInfo.price" type="text" />
          </div>
          <div>
            <button @click="addCourseToList">添加课程列表</button>
          </div>
        </div>
...
export default {
  ...
  methods: {
      addCourseToList(){
        this.courseList.push(this.coursrInfo)
      },
